...
FROM 'D:\CSIRO\3 Col\FACT 1911 - 1915.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
	...
	BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1916 - 1920.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1921 - 1925.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1926 - 1930.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1931 - 1935.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1936 - 1940.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1941 - 1945.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
BULK INSERT [DW1_FACT]
FROM 'D:\CSIRO\3 Col\FACT 1946 - 1950.csv'
WITH (
	FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\n', 
...
ALTER TABLE [DW1].[FACT] DROP COLUMN IF EXISTS [ID];
GO