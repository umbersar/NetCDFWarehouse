...
PRINT 'QUERY TESTING FOR DataWarehouse Structure 11 (DW11): OBT with a clustered columnstore, smalldatetime date format.'
PRINT 'COMMENT DW9 assembly took 6:40:15 hours - (with restricted processor affinity)'
PRINT 'COMMENT The OBT table occupies 49,121.367 MB, with 0 MB for the index.'
...
FROM [DW11].[OBT]		
WHERE [DateTime] = '19300730'---YEAR([DateTime]) = 1930 AND MONTH([DateTime]) = 7 AND DAY([DateTime]) = 30 -- SPECIFY TIMESTEP HERE
